...
const FICHA_PADRAO = {
  ...
  cuidados: [
    'Limpe com pano úmido e sabão neutro. Não vai na máquina de lavar louça.',
    'Não deixe em carro fechado nem sob sol direto: acima de ~55 °C o PLA amolece e a peça entorta.',
    'Não é estanque — para flores em água, use um copo ou tubo interno.',
  ],
};
...
const FICHAS = {
  ...
  'vaso-g':      { descricao:'A versão alta do Vaso Bauhaus, para galhos e folhagens longas. Base larga, não tomba fácil.',      medidas:'⌀ 12 × 24 cm',    peso:'190 g', cores:['vermelho','navy','mostarda','verde','creme'] },
...
function montarRodape(){
  ...
  alvo.innerHTML = `
    ...
    <div class="wrap footer-legal">
      ...
      <p>${EMPRESA.endereco} · ${EMPRESA.cidade} · CEP ${EMPRESA.cep}</p>
