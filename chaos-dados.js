  ...
  alvo.innerHTML = `
    ${emBreve() ? `
      <div class="aviso-breve">
        <p>Catálogo em preparação — as peças e os preços ainda não estão definitivos.
           Para saber quando a loja abrir, fale com a gente:
           ${whatsappHTML('Chame no WhatsApp')}.</p>
      </div>` : ''}
